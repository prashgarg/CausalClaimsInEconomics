      ...
      \begin{tikzpicture}
        \node[
          ...
          inner sep=6pt
            ...
            \resizebox{\linewidth}{!}{\input{figures/tikz/fig5b_banerjee_run1.tex}}
          \end{minipage}};
      \end{tikzpicture}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.47\textwidth}
      ...
      \begin{overlayarea}{\linewidth}{0.22\textheight}
        \visible<4->{\begin{tikzpicture}[>=Latex]
          \node[
            fill=white,
            draw=LineSoft,
            rounded corners=10pt,
      ...
      \begin{tikzpicture}
        \node[
          ...
          inner sep=6pt
            ...
            \resizebox{\linewidth}{!}{\input{figures/tikz/fig5a_chetty_run1.tex}}
          \end{minipage}};
      \end{tikzpicture}
      \vspace{0.12cm}
      ...
      \begin{tikzpicture}
        \node[
          ...
          inner sep=6pt
            ...
            \resizebox{\linewidth}{!}{\input{figures/tikz/fig6a_gabaix_run1.tex}}
          \end{minipage}};
      \end{tikzpicture}
      \vspace{0.1cm}
      ...
      \begin{tikzpicture}
        \node[
          ...
          inner sep=6pt
            ...
            \resizebox{\linewidth}{!}{\input{figures/tikz/fig6b_goldberg_run1.tex}}
          \end{minipage}};
      \end{tikzpicture}
      \vspace{0.1cm}
...
\begin{frame}[t,label=main-predictors]{Build the predictors result, one family at a time}
  \begin{tikzpicture}
    \node[inner sep=0,anchor=south west] (predfig) at (0,0) {\includegraphics[width=0.95\linewidth]{publication_predictors_main_five_measures.pdf}};
  ...
  \begin{columns}[T,onlytextwidth]
    \begin{column}{0.48\textwidth}
      \Card{0.97\linewidth}{What is released}{
        Derived edge lists, paper-level measures, prompts, schemas, and analysis code via the \href{https://github.com/prashgarg/CausalClaimsInEconomics}{project website}.}
    \end{column}
    \begin{column}{0.48\textwidth}
